...
namespace primitive.Alcantarea
{
    ...
    //[Guid(AlcantareaPackage.PackageGuidString)]
    ...
    public sealed class AlcantareaPackage : AsyncPackage
    {
        /// <summary>
        /// AlcantareaPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "557f912b-8883-4356-a3f4-b20eda1304b2";
        ...
        private void onStartDebugging(object sender, EventArgs e)
        {
            ...
            if (pid != 0)
            {
                ...
                uint cbSize = (uint)Marshal.SizeOf(info);
                ...
                IntPtr ptr = Marshal.AllocCoTaskMem((int) cbSize);
