    ...
    , m_preload_stop(false)
{
    ...
    case 2019: VCVersion="16.0"; break;
    default:
    ...
    char value[MAX_PATH] = "C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\Community\\VC\\Auxiliary\\Build\\";
    DWORD size = MAX_PATH;
    HKEY key;
    //printf("Debug succeeded. %s \t %d\n", __FUNCTION__, __LINE__);
    ...
    //if( retKey==ERROR_SUCCESS && retVal==ERROR_SUCCESS  ) {
        ...
        m_vcvars += " x86";
#endif // _WIN64
        printf("Debug succeeded. %s \t %s \t %d\n", m_vcvars.c_str() , __FUNCTION__, __LINE__);
    //}
    //printf("Debug succeeded. %s \t %d\n", __FUNCTION__, __LINE__);
    //::RegCloseKey( key );
}
